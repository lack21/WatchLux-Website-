...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const hiddenItems: NodeListOf<HTMLElement> =
  ...
  const topBtn: HTMLElement = document.querySelector(".top-btn")!;

  const navLinks: HTMLElement = document.querySelector(".links")!;
